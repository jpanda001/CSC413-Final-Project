...
def convolution2D(input_features, output_channels, kernel, strides, activation=True, \
    ...
    conv_output = K.layers.Conv2D(filters=output_channels, kernel_size=kernel, strides=strides, \
        padding="same", activation=None, use_bias=True, kernel_initializer='glorot_uniform', 
